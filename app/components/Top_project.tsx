      ...
      <div>
        <div className="flex flex-col justify-center items-start mt-3 min-h-[15rem] w-[23rem] rounded-md bg-[#007acc] p-4">
          <div className="flex-1">
            ...
            Textboard represents a pioneering online tool developed by the 2024 I3 GIC2B students at Institute of Technology of Cambodia. It empowers users to input text and personalize its animation, direction, font selection, and other customizable features.
            </p>
          </div>
